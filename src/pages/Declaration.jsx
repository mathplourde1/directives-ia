    ...
    <div style={{ background: '#F2F2F2', color: '#231F20', margin: 0, padding: 20, minHeight: '100vh' }}>
      ...
      <>
          ...
          <div className="section-box">
            ...
            <p style={{ margin: '0 0 10px 0', fontSize: '0.88em', color: '#555', fontStyle: 'italic' }}>Les champs obligatoires de la session et de cette section d'identification doivent être valides pour continuer.</p>
