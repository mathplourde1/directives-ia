    ...
    <div style={{ background: '#F2F2F2', color: '#231F20', margin: 0, padding: 20, minHeight: '100vh' }}>
      ...
      <>
          ...
          <div style={{ position: 'relative' }}>
            {(() => {
              const identOk = studentNom.trim() && (!isEquipe || (equipiers.length > 0 && equipiers[0].trim()));
          ...
          <div className="section-box" style={{ padding: 0, overflow: 'hidden', opacity: (studentNom.trim() && (!isEquipe || (equipiers.length > 0 && equipiers[0].trim()))) ? 1 : 0.5, pointerEvents: (studentNom.trim() && (!isEquipe || (equipiers.length > 0 && equipiers[0].trim()))) ? 'auto' : 'none' }}>
