    ...
    <div>
      ...
      {open && (
        <div style={{ textAlign: 'left', paddingTop: 6 }}>
          ...
          <b>Déclaration d'utilisation de SIA: Aidée de l'IA.</b><br />Tous les textes présentés ont été validés par l'équipe de développement. Le code a été développé par Mathieu Plourde avec l'aide de ChatGPT et Claude, mais plus particulièrement par Base44 pour cette version actuelle. <br /><br />Elle est développée et maintenue par Mathieu Plourde, CC-BY 4.0 2026 (version alpha 7).
        </div>
      )}
    </div>
  );
  ...
  return (
    <div style={{ background: '#F2F2F2', color: '#231F20', margin: 0, padding: 20, minHeight: '100vh' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        <div className="mb-2">Ce formulaire interactif s’adresse aux personnes enseignantes de l’Université Laval. Il vous permet de rédiger les directives, à l’intention des personnes étudiantes, d'autorisation d'utilisation des systèmes d'intelligence artificielle (SIA), selon trois phases de réalisation d’une évaluation.</div>
