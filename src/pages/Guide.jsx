...
export default function Guide() {
  ...
  return (
    ...
    🔒 Vos données ne sont pas conservées. Créez un <a href="#sauvegarde" className="text-blue-800 underline">fichier de sauvegarde</a> qui vous permettra de reprendre votre travail plus tard (fonction <strong>Importer un fichier de sauvegarde</strong>).
        </div>
      ...
      <div id="declaration" style={{ marginTop: 20, padding: '16px 20px', border: '1px solid #1895FD', borderRadius: 8, background: 'white' }}>
        ...
        <div style={{ marginBottom: 16, fontSize: '0.93em', color: '#444', lineHeight: 1.6 }}>
          Au-delà des directives que vous avez rédigé, si vous désirez que vos étudiantes et étudiants vous soumettent une déclaration d'utilisation des SIA dans le cadre de cette évaluation, vous pouvez leur offrir un gabarit Word déjà filtré ou une version interactive en gle.
        </div>
        <button
          type="button"
