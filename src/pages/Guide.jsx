...
export default function Guide() {
  ...
  return (
    <div style={{ background: '#F2F2F2', color: '#231F20', margin: 0, padding: 20, minHeight: '100vh' }}>
      ...
      <div className="mr-5 mb-2 ml-5">Précisez, à l’aide de ce formulaire interactif, les autorisations et les directives d’utilisation des systèmes d'intelligence artificielle (SIA) pour une évaluation. C’est un outil simple pour obtenir des directives complètes et prêtes à transmettre pour accompagner les étudiants et étudiantes.</div>
