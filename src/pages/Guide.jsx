...
const ETAPES = [
  ...
  { id: "tutorat", libelle: "Tutorat", parenthese: "se faire expliquer un concept; répondre à des questions préparatoires", sequence: 2 },
  { id: "accessibilite", libelle: "Accessibilité", parenthese: "générer et consulter du contenu en le changeant de format - texte alternatif, sous-titres automatisés, lecture orale, etc.", sequence: 3 },
  { id: "ideation", libelle: "Idéation/tempête d'idées", parenthese: "générer des exemples, des plans, des cas fictifs, des pistes d'argumentation; cadrer un sujet", sequence: 4 },
  { id: "capture", libelle: "Capture et saisie assistée", parenthese: "capturer, annoter ou étiquetter des données qualitatives ou des réunions", sequence: 5 },
  { id: "analyse", libelle: "Analyse d'informations", parenthese: "traiter, gérer ou analyser des fichiers, tableaux, corpus, données ou cartes conceptuelles", sequence: 6 },
  { id: "traduction", libelle: "Traduction", parenthese: "consulter un document en langue étrangère; faire traduire un extrait à insérer comme citation", sequence: 7 },
  { id: "redaction", libelle: "Rédaction", parenthese: "générer un texte entier texte; faire compléter un texte partiellement rédigé", sequence: 8 },
  { id: "production", libelle: "Production", parenthese: "générer du code, une modélisation, un script, un scénario, de la documentation ou un prototype", sequence: 9 },
  { id: "validation", libelle: "Validation du SIAg", parenthese: "demander au SIAg de valider ses affirmations; utiliser un autre outil ou méthode pour vérifier le contenu", sequence: 10 },
  { id: "revision", libelle: "Révision linguistique", parenthese: "effectuer une révision grammaticale, syntaxique ou stylistique", sequence: 11 },
  { id: "resolution", libelle: "Résolution de problèmes", parenthese: "déboguer du code; cerner le problème; expliquer une démarche; générer des solutions plausibles; faire des calculs", sequence: 12 },
  { id: "forme", libelle: "Mise en forme", parenthese: "harmoniser les styles graphiques, la présentation ou l'esthétique; assurer le respect des normes de citation, des tableaux et figures", sequence: 13 },
  { id: "multi", libelle: "Création multimodale", parenthese: "générer des images, des diagrammes, des capsules audio, des vidéos, des supports de présentation, des animations ou des expériences interactives", sequence: 14 },
  { id: "agentique", libelle: "Utilisation agentique", parenthese: "recourir à un agent autonome effectuant des tâches séquentielles, navigation web, exécution de code en boucle", sequence: 15 },
  { id: "situation", libelle: "Situation d'évaluation", parenthese: "utiliser un assistant IA en situation d'évalution synchrone ou asynchrone pour suggérer des réponses", sequence: 16 },
  { id: "autres", libelle: "Autres - Préciser:", parenthese: "", sequence: 17 },
];
