...
export default function Guide() {
  ...
  return (
    <div style={{ background: '#F2F2F2', color: '#231F20', margin: 0, padding: 20, minHeight: '100vh' }}>
      ...
      <div style={{ marginTop: 28, padding: '16px 20px', border: '1px solid #ccc', borderRadius: 8, background: 'white' }}>
        <button
          type="button"
        ...
        {declarationActive && (
          <div style={{ marginTop: 14, padding: '14px 18px', background: '#f0f8ff', border: '1px solid #b3d9f4', borderRadius: 6, fontSize: '0.93em', lineHeight: 1.7 }}>
            ...
            <ol style={{ margin: 0, paddingLeft: 22 }}>
              ...
              <li>Importez le <strong>fichier de sauvegarde XML</strong> fourni par votre personne enseignante (disponible dans la section <a href="#sauvegarde" style={{ color: '#0056b3', textDecoration: 'underline' }}>Sauvegarde</a> ci-dessous).</li>
