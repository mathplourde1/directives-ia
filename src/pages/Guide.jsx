...
export default function Guide() {
  ...
  return (
    <div style={{ background: '#F2F2F2', color: '#231F20', margin: 0, padding: 20, minHeight: '100vh' }}>
      ...
      <li>(Optionnel) Transposez ces directives dans un formulaire de déclaration d’utilisation des SIA que les personnes étudiantes devront remplir en ligne et joindre à leur soumission (deux versions disponibles).</li>
      </ol>
