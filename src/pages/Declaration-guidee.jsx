...
function parseDirectivesXML(xmlText) {
  ...
  try {
    ...
    const identification = {
      ...
      contexte: getT(identNode, 'contexte') || 'individuel',
    };
...
export default function DeclarationGuidee() {
  ...
  function handleFile(e) {
    ...
    reader.onload = ev => {
      ...
      setData(result);
      if (result.ok) { setSessionOverride(''); setSessionEditMode(false); setSessionError(false); setApercu(null); setSubmitStatus(null); setIsEquipe(result.identification?.contexte === 'equipe'); }
    };
